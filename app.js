    ...
    if(loginForm) {
        loginForm.addEventListener("submit", async e => {
            ...
            try {
                ...
                console.warn("Supabase Login Failed (Offline?):", err);
            }
            ...
            if (user) {
                ...
                alert("Acesso Negado. Verifique o login e a senha.\n\nDica: Certifique-se de que não há espaços extras e se o teclado não colocou letra maiúscula.");
                btn.disabled = false;
...
window.generateInviteLink = () => {
    ...
    navigator.clipboard.writeText(inviteUrl).then(() => {
        alert("Link de Convite copiado!\n\nIMPORTANTE:\nAntes de enviar este link, clique no botão azul 'Push: Enviar dados' para garantir que os usuários e senhas atuais estejam na nuvem.");
    }).catch(err => {
